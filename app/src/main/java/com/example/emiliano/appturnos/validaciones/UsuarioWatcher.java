...
public class UsuarioWatcher implements TextWatcher {

    private TextView component;


    public UsuarioWatcher(EditText element) {
    ...
    public void afterTextChanged(Editable s) {
        ...
        if(n != 0 && n < 5 || n > 128){
            component.setError("El nombre de usuario debe contener al menos 5 caracteres y a lo sumo 128");
        }else{
